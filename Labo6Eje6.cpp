...
void eliminarNumero(listaDatos** lista);
void imprimirMenu(void);
//Funciones de el arbol
nodo *crearnodo(int n);
void insertar(nodo *&arbol, int n);
void showArbol(nodo *arbol, int contador);
bool busquedaArbol(nodo *&arbol, int n);

void insertandoalArbol(nodo *&arbol, listaDatos* lista);
...
int main(void) {
	...
	cout<<"CODIGO DE: Francisco Edgardo Sosa Escobar"<<endl<<endl;
	do{
		...
		case 2:
			...
			break;
		case 3:
			insertandoalArbol(arbol, pInicio);
...
void insertandoalArbol(nodo *&arbol, listaDatos* lista){
	if(!lista)
		...
		insertandoalArbol(arbol, lista->sig);
	}	
}
